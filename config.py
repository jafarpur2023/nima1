...
OWNER_USERNAME = getenv("OWNER_USERNAME", "hastizamaniorg")
# Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME" , "FullMusicKingbot")
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6767132612").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/jafarpur2023/nima1",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/musictalk22")
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/FullMusicking")
